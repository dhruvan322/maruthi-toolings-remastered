...
export const MOCK_PRODUCTS_DB: Product[] = [
    ...
    { _id: '1', name: 'Complex Automotive Mould', category: 'Tools/Machines', description: 'A complex, two-shot (2K) mould for a next-gen vehicle dashboard, manufactured with high-grade tool steel.', imageUrl: 'https://picsum.photos/seed/automotive/800/600', gallery: ['https://picsum.photos/seed/automotive/800/600', 'https://picsum.photos/seed/automotive2/800/600', 'https://picsum.photos/seed/automotive3/800/600'], updatedAt: new Date('2024-09-15') },
    ...
    { _id: '8', name: 'Custom Bottle Cap Mould', category: 'Tools/Machines', description: '32-cavity mould for a unique, patented beverage bottle cap design with tamper-evident features.', imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdAz8lq4jHwvYOE1je7rfHZ8dB9JLvGQqr2kN27lYt7as29Z6Awq02R6K9qRUHLYmHd3g&usqp=CAU', gallery: ['https://p.globalsources.com/IMAGES/PDT/S1214254729/Injection-molds.jpg?ver=6016945389'], updatedAt: new Date('2024-06-11') },
    { _id: '11', name: 'Multi-Insert Mould Assembly', category: 'Tools/Machines', description: 'Complete multi-insert mould assembly for consumer electronics casing, designed for high-volume production.', imageUrl: 'https://d2n4wb9orp1vta.cloudfront.net/cms/0614ptMultiShot2.jpg;width=860', gallery: ['https://d2n4wb9orp1vta.cloudfront.net/cms/0614ptMultiShot1.jpg;maxWidth=1200'], updatedAt: new Date('2024-10-01') },
    { _id: '12', name: 'Large Container Mould', category: 'Tools/Machines', description: 'Single-cavity mould for large industrial containers, engineered for structural integrity and durability.', imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQR8CGNJpwFjKb75ar1aZVvSEyg-0-VnAQaSzdsZddJYfmy-uMq592yoZ1e32KpDfANL8g&usqp=CAU', gallery: ['https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLZNA0tLHfcwE2aCaL1u86izz5MEBsm0OBpA&s'], updatedAt: new Date('2024-09-25') },
